(() => {
    ...
    (e.modules = {
      ...
      8973: (e, t, s) => {
        ...
        let l = [
                      ...
                      children: [
                        "[id]",
                        {
                          children: [
                            ...
                            {
                              page: [
                                () => Promise.resolve().then(s.bind(s, 4176)),
          ...
          p = "/dashboard/payments/[id]/page",
          x = { require: s, loadChunk: () => Promise.resolve() },
          u = new r.AppPageRouteModule({
            definition: {
              kind: a.x.APP_PAGE,
              page: "/dashboard/payments/[id]/page",
              pathname: "/dashboard/payments/[id]",
              bundlePath: "",
              filename: "",
              appPaths: [],
            },
      ...
      1199: (e, t, s) => {
        Promise.resolve().then(s.bind(s, 1468));
      },
      1468: (e, t, s) => {
        "use strict";
        ...
        function i() {
          ...
          let [t, s] = (0, a.useState)(null),
            ...
            x = i?.startTime ? new Date(i.startTime) : null,
            u = i?.endTime ? new Date(i.endTime) : null;
          return (0, r.jsxs)("div", {
            className: "space-y-6",
            children: [
              o &&
                      ...
                      children: [
                        ...
                        (0, r.jsxs)("p", {
                          ...
                          children: [
                            ...
                            i.matatu?.plate || "Unknown",
                            " on route",
                            " ",
                            i.matatu?.route || "Route not set",
                            ".",
                          ],
                        }),
                      ],
                        ...
                        (0, r.jsxs)("div", {
                          ...
                          children: [
                            ...
                            r.jsx("div", {
                              ...
                              children: i.matatu?.plate || "Unknown",
                            }),
                            r.jsx("div", {
                              className: "text-[11px] text-slate-400",
                              children: i.matatu?.route || "Route not set",
                            }),
                          ],
                        }),
                      ],
      ...
      4176: (e, t, s) => {
        "use strict";
        (s.r(t),
          s.d(t, { $$typeof: () => i, __esModule: () => d, default: () => n }));
        var r = s(8570);
        let a = (0, r.createProxy)(
            String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\dashboard\payments\[id]\page.tsx`,
          ),
          { __esModule: d, $$typeof: i } = a;
        a.default;
        let n = (0, r.createProxy)(
          String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\dashboard\payments\[id]\page.tsx#default`,
        );
      },
    }));
  ...
  t.C(e);
  var s = (e) => t((t.s = e)),
    r = t.X(0, [489, 496, 462, 754], () => s(8973));
  module.exports = r;
})();
