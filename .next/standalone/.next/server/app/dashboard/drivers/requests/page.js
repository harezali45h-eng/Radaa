(() => {
  ...
  ((e.id = 577),
    ...
    (e.modules = {
        ...
        let l = [
            "",
            {
              children: [
                      ...
                      children: [
                        "requests",
                        {
                          children: [
                            ...
                            {
                              page: [
                                () => Promise.resolve().then(r.bind(r, 1150)),
                ...
                {
                  layout: [
                    () => Promise.resolve().then(r.bind(r, 3321)),
                    "C:\\Users\\wesley\\Desktop\\Radaa\\radaa-frontend\\app\\dashboard\\layout.tsx",
                  ],
                  loading: [
                    () => Promise.resolve().then(r.bind(r, 4481)),
          ...
          u = "/dashboard/drivers/requests/page",
          p = { require: r, loadChunk: () => Promise.resolve() },
          x = new s.AppPageRouteModule({
            definition: {
              kind: a.x.APP_PAGE,
              page: "/dashboard/drivers/requests/page",
              pathname: "/dashboard/drivers/requests",
              bundlePath: "",
              filename: "",
              appPaths: [],
            },
      ...
      8878: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 8003));
      },
      8003: (e, t, r) => {
        "use strict";
        ...
        function l() {
          let { token: e } = (0, i.a)(),
            { addNotification: t } = (0, o.z)(),
            { on: r, off: l } = (0, n.s)(),
            [c, u] = (0, a.useState)(!1),
            [p, x] = (0, a.useState)(null),
            [h, m] = (0, a.useState)([]),
            [b, y] = (0, a.useState)(!0),
      ...
      4951: (e, t, r) => {
        ...
        async function a(e, t = {}) {
          let r;
          let { method: a = "GET", body: i, token: o } = t,
            n = {};
          o && (n.Authorization = `Bearer ${o}`);
          for (let t = 1; t <= 3; t += 1)
            try {
              let t = (
                await s.ZP.request({ url: e, method: a, data: i, headers: n })
              ).data;
              if (
                null != t &&
                t &&
              ...
              ((r = i), console.error("API ERROR:", i?.response?.data || i));
              let e = i?.response?.status,
                s = i?.response?.data,
                a =
          ...
          throw r instanceof Error ? r : Error("Request failed");
        }
      ...
      1150: (e, t, r) => {
        ...
        let a = (0, s.createProxy)(
            String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\dashboard\drivers\requests\page.tsx`,
          ),
          { __esModule: i, $$typeof: o } = a;
        a.default;
        let n = (0, s.createProxy)(
          String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\dashboard\drivers\requests\page.tsx#default`,
        );
      },
    }));
  ...
  t.C(e);
  var r = (e) => t((t.s = e)),
    s = t.X(0, [489, 496, 462, 754], () => r(3793));
  module.exports = s;
})();
