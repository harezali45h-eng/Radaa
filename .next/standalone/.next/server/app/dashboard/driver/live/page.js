(() => {
    ...
    (e.modules = {
      ...
      8565: (e, t, s) => {
        ...
        let d = [
                      ...
                      children: [
                        "live",
                        {
                          children: [
                            ...
                            {
                              page: [
                                () => Promise.resolve().then(s.bind(s, 4069)),
          ...
          u = "/dashboard/driver/live/page",
          x = { require: s, loadChunk: () => Promise.resolve() },
          p = new r.AppPageRouteModule({
            definition: {
              kind: a.x.APP_PAGE,
              page: "/dashboard/driver/live/page",
              pathname: "/dashboard/driver/live",
              bundlePath: "",
              filename: "",
              appPaths: [],
            },
      ...
      8718: (e, t, s) => {
        Promise.resolve().then(s.bind(s, 8864));
      },
      8864: (e, t, s) => {
        "use strict";
        ...
        async function u(e, t = {}) {
          let s;
          let { method: r = "GET", body: a, token: n } = t,
            l = {};
          n && (l.Authorization = `Bearer ${n}`);
          for (let t = 1; t <= 3; t += 1)
            try {
              let t = (
                await c.ZP.request({ url: e, method: r, data: a, headers: l })
              ).data;
              if (
                null != t &&
                t &&
              ...
              ((s = n), console.error("API ERROR:", n?.response?.data || n));
        ...
        var p = s(4545),
          m = s(7039);
        function h() {
          let { user: e, token: t, loading: s } = (0, n.a)(),
            { addNotification: c } = (0, l.z)(),
            { on: u, off: h, emit: b } = (0, i.s)(),
            { driverOnline: f, setDriverOnline: g } = (0, o.r)(),
            y = e?.role,
            v = (0, p.N3)("driver_onboard_v1", !1),
                ...
                w
                  .map((e) => {
                    ...
                    if (
                      ...
                      return null;
                    let [s, r] = t.coordinates;
                    return "number" != typeof r || "number" != typeof s
                      ? null
                      : {
                          id: String(e._id || e.id || `${r},${s}`),
                          location: { lat: r, lng: s },
                        };
                  })
                  .filter(Boolean),
              [w],
            ...
            U = (0, a.useMemo)(() => {
              ...
              return (
                ...
                { minLat: t, maxLat: s, minLng: r, maxLng: a }
              );
            }, [j, L]),
            G = (0, a.useMemo)(() => null !== U, [U]);
          return s || !e || "driver" !== y
            ? r.jsx("div", {
                className: "space-y-4",
                  ...
                  (0, r.jsxs)("section", {
                    ...
                    children: [
                      ...
                      r.jsx("button", {
                        type: "button",
                        onClick: () => g(!f),
                        className: `inline-flex items-center rounded-full px-3 py-1 text-[11px] font-medium transition ${f ? "bg-emerald-600/80 text-emerald-50 hover:bg-emerald-500/80" : "bg-slate-800 text-slate-100 hover:bg-slate-700"}`,
                        children: f ? "Go offline" : "Go online",
                      }),
                    ],
                  }),
                  (0, r.jsxs)("section", {
                      ...
                      r.jsx(m.Z, {
                        ...
                        project: (e) => {
                          ...
                          let t = Math.max(U.maxLat - U.minLat, 1e-4),
                            s = Math.max(U.maxLng - U.minLng, 1e-4),
                            r = ((e.lng - U.minLng) / s) * 100,
                            a = 100 - ((e.lat - U.minLat) / t) * 100;
                          return {
                            left: `${Math.min(100, Math.max(0, r))}%`,
                            top: `${Math.min(100, Math.max(0, a))}%`,
                          };
                        },
                        onCenterOnMe: () => {},
                        onSelectMatatu: () => {},
                                  ...
                                  r.jsx("tbody", {
                                    children: w.map((e) => {
                                      ...
                                      if (
                                        ...
                                        Number.isFinite(s) &&
                                          (l = `${(s / 1e3).toFixed(1)} km \xb7 ~${Math.round((s / 1e3 / 25) * 60)} min`);
                                      }
                                      return (0, r.jsxs)(
                                        "tr",
                                        {
      ...
      7039: (e, t, s) => {
        ...
        var r = s(326),
          a = s(7577),
          n = s(4545);
        let l = function ({ matatu: e, status: t, style: s, onSelect: l }) {
            let i = (function (e) {
                if (!e) return "Matatu";
              ...
              o = (0, n.N3)("map_photos_v1", !1),
              d = (0, a.useMemo)(() => {
                if (!o || !e.mainPhotoUrl) return null;
      ...
      4951: (e, t, s) => {
        ...
        async function a(e, t = {}) {
          let s;
          let { method: a = "GET", body: n, token: l } = t,
            i = {};
          l && (i.Authorization = `Bearer ${l}`);
          for (let t = 1; t <= 3; t += 1)
            try {
              let t = (
                await r.ZP.request({ url: e, method: a, data: n, headers: i })
              ).data;
              if (
                null != t &&
                t &&
      ...
      4069: (e, t, s) => {
        ...
        let a = (0, r.createProxy)(
            String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\dashboard\driver\live\page.tsx`,
          ),
          { __esModule: n, $$typeof: l } = a;
        a.default;
        let i = (0, r.createProxy)(
          String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\dashboard\driver\live\page.tsx#default`,
        );
      },
    }));
  ...
  t.C(e);
  var s = (e) => t((t.s = e)),
    r = t.X(0, [489, 496, 462, 754], () => s(8565));
  module.exports = r;
})();
