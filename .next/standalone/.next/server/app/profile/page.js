(() => {
  ...
  ((e.id = 178),
    ...
    (e.modules = {
              ...
              children: [
                "profile",
                {
                  children: [
                    ...
                    {
                      page: [
                        () => Promise.resolve().then(t.bind(t, 4591)),
                ...
                {
                  layout: [
                    () => Promise.resolve().then(t.bind(t, 5221)),
                    "C:\\Users\\wesley\\Desktop\\Radaa\\radaa-frontend\\app\\profile\\layout.tsx",
                  ],
                },
              ],
            },
      ...
      4493: (e, s, t) => {
        Promise.resolve().then(t.bind(t, 9776));
      },
      9150: (e, s, t) => {
        Promise.resolve().then(t.bind(t, 8333));
      },
      9776: (e, s, t) => {
        "use strict";
        ...
        function i() {
          let { user: e } = (0, l.a)(),
            ...
            i = s ? (s.loyalty.paidRidesCount / 10) * 100 : 0,
            d = e?.role === "driver";
          return (0, r.jsxs)("div", {
            className: "space-y-6",
            children: [
                        ...
                        (0, r.jsxs)("span", {
                          ...
                          children: [
                            ...
                            r.jsx("span", {
                              ...
                              children: e.driverVerificationStatus || "pending",
                            }),
                          ],
                        }),
                      ],
                          ...
                          children: [
                            ...
                            r.jsx("div", {
                              className:
                                "mt-1 text-sm font-semibold text-slate-100",
                              children:
                                e.driverProfile?.licenseNumber || "Not set",
                            }),
                          ],
                        }),
                        (0, r.jsxs)("div", {
                          children: [
                            ...
                            r.jsx("div", {
                              className:
                                "mt-1 text-sm font-semibold text-slate-100",
                              children: e.driverProfile?.saccoName || "Not set",
                            }),
                          ],
                        }),
                        (0, r.jsxs)("div", {
                          children: [
                            ...
                            r.jsx("div", {
                              className:
                                "mt-1 text-sm font-semibold text-slate-100",
                              children:
                                e.driverProfile?.vehicleRegistration ||
                                "Not set",
                            }),
                          ],
                        }),
                  ...
                  (0, r.jsxs)("div", {
                    ...
                    children: [
                      ...
                      r.jsx("div", {
                        ...
                        children: s?.loyalty?.freeRides ?? 0,
                      }),
                    ],
                  }),
                ],
                ...
                children: [
                  ...
                  r.jsx("div", {
                    ...
                    children: r.jsx("div", {
                      ...
                      style: { width: `${Math.max(0, Math.min(100, i))}%` },
                    }),
                  }),
                ],
              }),
      ...
      8333: (e, s, t) => {
        ...
        function x() {
          ...
          return (0, r.jsxs)("button", {
            type: "button",
            onClick: () => {
              let t = "driver" === s ? "/dashboard/driver/live" : "/dashboard";
            ...
            className: `${t} gap-1 text-xs`,
            children: [
              r.jsx("span", { className: "mr-1", children: "←" }),
              "Back to Dashboard",
            ],
          });
        }
        ...
        function p({ children: e }) {
          let s = (0, i.usePathname)(),
            { user: t, token: p, logout: h } = (0, d.a)(),
            { notifications: u, unreadCount: f, markAllAsRead: v } = (0, n.z)(),
            [j, b] = (0, a.useState)(!1),
            { connect: N } = (0, m.s)(),
            { driverOnline: g, setDriverOnline: y, activeMode: w } = (0, o.r)(),
            { headerBgClass: k } = (0, c.F)(),
            P = "/dashboard" === s,
            q = s.startsWith("/dashboard/"),
            C = s.startsWith("/auth"),
            _ = "/" !== s && !C && !P,
            R = t?.role,
            D = "admin" === R,
      ...
      5221: (e, s, t) => {
        ...
        function l({ children: e }) {
          return r.jsx(a.V, { children: e });
        }
      },
      4591: (e, s, t) => {
        "use strict";
        (t.r(s),
          t.d(s, { $$typeof: () => i, __esModule: () => l, default: () => d }));
        var r = t(8570);
        let a = (0, r.createProxy)(
            String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\profile\page.tsx`,
          ),
          { __esModule: l, $$typeof: i } = a;
        a.default;
        let d = (0, r.createProxy)(
          String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\profile\page.tsx#default`,
        );
      },
      8213: (e, s, t) => {
        "use strict";
