(() => {
  ...
  ((e.id = 74),
    ...
    (e.modules = {
        ...
        let o = [
            "",
            {
              children: [
                ...
                {
                  layout: [
                    () => Promise.resolve().then(t.bind(t, 6988)),
                    "C:\\Users\\wesley\\Desktop\\Radaa\\radaa-frontend\\app\\payments\\layout.tsx",
                  ],
                },
              ],
            },
      ...
      4991: (e, s, t) => {
        Promise.resolve().then(t.bind(t, 4732));
      },
      9150: (e, s, t) => {
      ...
      4732: (e, s, t) => {
        ...
        var l = t(7772);
        function i() {
          let { addNotification: e } = (0, l.z)(),
            [s, t] = (0, r.useState)(50),
            [i, n] = (0, r.useState)("mpesa"),
            [d, o] = (0, r.useState)(""),
      ...
      8333: (e, s, t) => {
        ...
        function u({ children: e }) {
          let s = (0, i.usePathname)(),
            { user: t, token: u, logout: m } = (0, n.a)(),
            { notifications: h, unreadCount: f, markAllAsRead: b } = (0, d.z)(),
            [y, v] = (0, r.useState)(!1),
            { connect: g } = (0, p.s)(),
            { driverOnline: j, setDriverOnline: N, activeMode: w } = (0, o.r)(),
            { headerBgClass: k } = (0, c.F)(),
            q = "/dashboard" === s,
            P = s.startsWith("/dashboard/"),
            C = s.startsWith("/auth"),
            S = "/" !== s && !C && !q,
            _ = t?.role,
            D = "admin" === _,
                      ...
                      children: [
                        ...
                        (q || P) &&
                          ...
                          (0, a.jsxs)("button", {
                            ...
                            className: `inline-flex items-center rounded-md border px-2 py-1 text-[11px] font-medium shadow-sm transition ${j ? "border-emerald-500/80 bg-emerald-600/20 text-emerald-200" : "border-slate-700 bg-slate-900 text-slate-200 hover:border-slate-500"}`,
                            children: [
                              a.jsx("span", {
                                className: `mr-1 h-1.5 w-1.5 rounded-full ${j ? "bg-emerald-400" : "bg-slate-500"}`,
                              }),
                              "Driver Mode",
                            ],
                          }),
      ...
      666: (e, s, t) => {
        "use strict";
        (t.r(s),
          t.d(s, { $$typeof: () => i, __esModule: () => l, default: () => n }));
        var a = t(8570);
        let r = (0, a.createProxy)(
            String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\payments\page.tsx`,
          ),
          { __esModule: l, $$typeof: i } = r;
        r.default;
        let n = (0, a.createProxy)(
          String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\payments\page.tsx#default`,
        );
      },
      8213: (e, s, t) => {
        "use strict";
