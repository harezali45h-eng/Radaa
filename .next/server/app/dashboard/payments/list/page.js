(() => {
    ...
    (e.modules = {
      ...
      1272: (e, t, s) => {
        ...
        let o = [
          ...
          x = "/dashboard/payments/list/page",
          p = { require: s, loadChunk: () => Promise.resolve() },
          u = new r.AppPageRouteModule({
            definition: {
              kind: a.x.APP_PAGE,
              page: "/dashboard/payments/list/page",
              pathname: "/dashboard/payments/list",
              bundlePath: "",
              filename: "",
              appPaths: [],
            },
      ...
      4922: (e, t, s) => {
        Promise.resolve().then(s.bind(s, 5968));
      },
      5968: (e, t, s) => {
        "use strict";
        ...
        function d() {
          let [e, t] = (0, a.useState)(null),
            ...
            u = i.filter((e) => "completed" === e.status && null != e.fare);
          return (0, r.jsxs)("div", {
            className: "space-y-6",
            children: [
              (0, r.jsxs)("header", {
                                ...
                                "tr",
                                {
                                  ...
                                  children: [
                                    ...
                                    r.jsx("td", {
                                      ...
                                      children: r.jsx(l.default, {
                                        href: `/dashboard/payments/${e._id}`,
                                        className:
        ...
        (s(6334), process.env.NEXT_PUBLIC_API_BASE_URL);
      },
      3862: (e, t, s) => {
        "use strict";
        (s.r(t),
          s.d(t, { $$typeof: () => d, __esModule: () => l, default: () => i }));
        var r = s(8570);
        let a = (0, r.createProxy)(
            String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\dashboard\payments\list\page.tsx`,
          ),
          { __esModule: l, $$typeof: d } = a;
        a.default;
        let i = (0, r.createProxy)(
          String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\dashboard\payments\list\page.tsx#default`,
        );
      },
    }));
  ...
  t.C(e);
  var s = (e) => t((t.s = e)),
    r = t.X(0, [489, 496, 462, 754], () => s(1272));
  module.exports = r;
})();
