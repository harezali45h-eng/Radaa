(() => {
    ...
    (e.modules = {
      ...
      9008: (e, t, s) => {
        ...
        let o = [
                      ...
                      children: [
                        "list",
                        {
                          children: [
                            ...
                            {
                              page: [
                                () => Promise.resolve().then(s.bind(s, 2309)),
          ...
          c = "/dashboard/matatus/list/page",
          p = { require: s, loadChunk: () => Promise.resolve() },
          u = new r.AppPageRouteModule({
            definition: {
              kind: a.x.APP_PAGE,
              page: "/dashboard/matatus/list/page",
              pathname: "/dashboard/matatus/list",
              bundlePath: "",
              filename: "",
              appPaths: [],
            },
      ...
      903: (e, t, s) => {
        Promise.resolve().then(s.bind(s, 9694));
      },
      9694: (e, t, s) => {
        "use strict";
      ...
      2309: (e, t, s) => {
        ...
        let a = (0, r.createProxy)(
            String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\dashboard\matatus\list\page.tsx`,
          ),
          { __esModule: l, $$typeof: i } = a;
        a.default;
        let n = (0, r.createProxy)(
          String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\dashboard\matatus\list\page.tsx#default`,
        );
      },
    }));
  ...
  t.C(e);
  var s = (e) => t((t.s = e)),
    r = t.X(0, [489, 496, 462, 754], () => s(9008));
  module.exports = r;
})();
