(() => {
    ...
    (e.modules = {
      ...
      7229: (e, t, s) => {
        ...
        let o = [
                  ...
                  children: [
                    "sacco",
                    {
                      children: [
                        ...
                        {
                          page: [
                            () => Promise.resolve().then(s.bind(s, 4603)),
          ...
          x = "/dashboard/sacco/page",
          p = { require: s, loadChunk: () => Promise.resolve() },
          u = new a.AppPageRouteModule({
            definition: {
              kind: r.x.APP_PAGE,
              page: "/dashboard/sacco/page",
              pathname: "/dashboard/sacco",
              bundlePath: "",
              filename: "",
              appPaths: [],
            },
      ...
      4022: (e, t, s) => {
        Promise.resolve().then(s.bind(s, 3708));
      },
      3708: (e, t, s) => {
        "use strict";
        ...
        var a = s(326),
          ...
          o = s(676);
        function c() {
          let { user: e, token: t } = (0, l.a)(),
            s = e?._id,
            c = e?.saccoProfile?.saccoName,
            [x, p] = (0, r.useState)(null),
            [u, m] = (0, r.useState)([]),
            [h, b] = (0, r.useState)([]),
            [f, g] = (0, r.useState)(!0),
            [j, y] = (0, r.useState)(null),
            [v, N] = (0, r.useState)("permit"),
            [_, w] = (0, r.useState)(null),
            [k, C] = (0, r.useState)(!1),
            { matatus: P } = (0, d.r)(),
            [q, S] = (0, r.useState)(null),
            A = e?.role === "admin";
          (0, n.N3)("sacco_onboard_v1", !1);
          let { cardSurfaceClass: M } = (0, o.F)(),
            R = (0, r.useMemo)(
              () => u.filter((e) => "pending" === e.driverVerificationStatus),
              [u],
            ),
            $ = (0, r.useMemo)(
              () => h.filter((e) => "pending" === e.approvalStatus),
              [h],
            ),
            D = (0, r.useMemo)(() => {
              if (!Array.isArray(h) || 0 === h.length) return [];
              let e = new Map(h.map((e) => [e._id, e])),
                t = new Map();
              return (
                h.forEach((e) => {
                ...
                P.map((s) => {
                  ...
                  a)
                    ? {
                        id: a._id,
                        plate: a.plate || a.numberPlate || s.plate,
                        numberPlate: a.numberPlate || s.numberPlate,
                        route: a.route || s.route,
          ...
          ((0, r.useMemo)(() => null !== E, [E]),
            (0, r.useCallback)(
              (e) => {
                if (!e || !E) return { left: "50%", top: "50%" };
                let t = Math.max(E.maxLat - E.minLat, 1e-4),
                  s = Math.max(E.maxLng - E.minLng, 1e-4),
                  a = ((e.lng - E.minLng) / s) * 100,
                  r = 100 - ((e.lat - E.minLat) / t) * 100;
                return {
            ...
            (0, r.useMemo)(
              () =>
                D.reduce(
                  (e, t) => (t.location && (e[t.id] = t.location), e),
                  {},
                ),
              [D],
            ));
          let U = async (e) => {
              if ((e.preventDefault(), s && t && _)) {
                C(!0);
                try {
                  await (0, i.o)(s, v, _, t);
                } catch (e) {
                  y(e instanceof Error ? e.message : "Document upload failed");
                } finally {
                  C(!1);
                }
              }
            ...
            O = async (e, a) => {
              if (s && t)
                try {
                  let r = await (0, i.Vh)(s, e, a, t);
                  m((e) => e.map((e) => (e._id === r._id ? r : e)));
                } catch (e) {
                  y(e instanceof Error ? e.message : "Unable to update driver");
                }
            },
            L = async (e, a) => {
              if (s && t)
                try {
                  let r = await (0, i.v7)(s, e, a, t);
                  m((e) => e.map((e) => (e._id === r._id ? r : e)));
                } catch (e) {
                  y(e instanceof Error ? e.message : "Unable to update driver");
                }
            ...
            T = async (e, a) => {
              if (s && t)
                try {
                  let r = await (0, i.yb)(s, e, a, t);
                  b((e) => e.map((e) => (e._id === r._id ? r : e)));
                } catch (e) {
                  y(e instanceof Error ? e.message : "Unable to update matatu");
                }
            };
          return A
            ? (0, a.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, a.jsxs)("section", {
                    ...
                    children: [
                      (0, a.jsxs)("div", {
                        className: `space-y-3 ${M} p-4 text-xs`,
                        children: [
                          a.jsx("div", {
                  ...
                  (0, a.jsxs)("section", {
                    ...
                    children: [
                      (0, a.jsxs)("div", {
                        className: `space-y-2 ${M} p-4 text-xs`,
                        children: [
                          a.jsx("h3", {
                            className: "text-sm font-semibold text-slate-100",
                              ...
                              children: R.map((e) =>
                                (0, a.jsxs)(
                                  "li",
                                  {
                                    ...
                                    children: [
                                      a.jsx("span", { children: e.username }),
                                      (0, a.jsxs)("div", {
                                        className: "inline-flex gap-1",
                                        children: [
                                          a.jsx("button", {
                                            type: "button",
                                            onClick: () => O(e._id, "approved"),
                                            className:
                                              "rounded-full bg-emerald-600/80 px-2 py-0.5 text-[10px] text-emerald-50 hover:bg-emerald-500/80",
                                            children: "Approve",
                                          }),
      ...
      5792: (e, t, s) => {
        "use strict";
        s.d(t, { Vh: () => n, o: () => l, v7: () => i, yb: () => d });
        var a = s(6334);
        async function r(e, t = {}) {
          let { method: s = "GET", body: r, token: l } = t,
            i = {};
          l && (i.Authorization = `Bearer ${l}`);
          try {
            let t = (
              await a.ZP.request({ url: e, method: s, data: r, headers: i })
            ).data;
            if (
              null != t &&
              t &&
        ...
        async function l(e, t, s, a) {
          ...
          return (
            l.append("file", s),
            l.append("type", t),
            r(`/sacco/${e}/docs`, { method: "POST", body: l, token: a ?? null })
          );
        }
        async function i(e, t, s, a) {
          return r(`/sacco/${e}/driver/${t}/disable`, {
            method: "POST",
            body: { enabled: s },
            token: a ?? null,
          });
        ...
        async function n(e, t, s, a) {
          return r(`/sacco/${e}/driver/${t}/verification`, {
            method: "POST",
            body: { status: s },
            token: a ?? null,
          });
        ...
        async function d(e, t, s, a) {
          return r(`/sacco/${e}/matatu/${t}/approval`, {
            method: "POST",
            body: { status: s },
            token: a ?? null,
          });
      ...
      4603: (e, t, s) => {
        ...
        let r = (0, a.createProxy)(
            String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\dashboard\sacco\page.tsx`,
          ),
          { __esModule: l, $$typeof: i } = r;
        r.default;
        let n = (0, a.createProxy)(
          String.raw`C:\Users\wesley\Desktop\Radaa\radaa-frontend\app\dashboard\sacco\page.tsx#default`,
        );
      },
    }));
  ...
  t.C(e);
  var s = (e) => t((t.s = e)),
    a = t.X(0, [489, 496, 462, 754], () => s(7229));
  module.exports = a;
})();
