      ...
      class y extends i.default.Component {
        ...
        render() {
          ...
          P &&
            ...
            (P = O.concat(x)));
          let v = i.default.Children.toArray(this.props.children).filter(
            Boolean,
          );
          E && !o && (v = this.makeStylesheetInert(v));
          let N = !1,
            b = !1;
              ...
              !o &&
                (0, r.jsxs)(r.Fragment, {
                  children: [
                    ...
                    !g && this.getCssLinks(j),
                    !g &&
                      (0, r.jsx)("noscript", {
                        "data-n-css": this.props.nonce ?? "",
                      }),
                    !I && !T && this.getPreloadDynamicChunks(),
                    !I && !T && this.getPreloadMainLinks(j),
                    !_ && !I && this.getPolyfillScripts(),
                    !_ && !I && this.getPreNextScripts(),
                    !_ && !I && this.getDynamicChunks(j),
                    !_ && !I && this.getScripts(j),
                    g && this.getCssLinks(j),
                    g &&
                      (0, r.jsx)("noscript", {
                        "data-n-css": this.props.nonce ?? "",
...
See more info here: https://nextjs.org/docs/messages/large-page-data`)),
    ...
    5104: (e, t, n) => {
      ...
      let r = n(167)._(n(979)),
        ...
        s = { [i.client]: 0, [i.server]: 1, [i.edgeServer]: 2 },
        a = "/_not-found",
        l = "" + a + "/page",
        u = "phase-export",
