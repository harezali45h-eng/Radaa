      ...
      let b = a.default.forwardRef(function (e, t) {
        ...
        let C = a.default.useContext(f.RouterContext),
          ...
          { href: L, as: W } = a.default.useMemo(() => {
            ...
            let [e, t] = (0, u.resolveHref)(C, i, !0);
            return { href: e, as: b ? (0, u.resolveHref)(C, b) : t || e };
          }, [C, i, b]),
          D = a.default.useRef(L),
          z = a.default.useRef(W);
        w && (n = a.default.Children.only(r));
        let K = w ? n && "object" == typeof n && n.ref : t,
          [q, F, $] = (0, p.useIntersection)({ rootMargin: "200px" }),
          B = a.default.useCallback(
            (e) => {
              ((z.current !== W || D.current !== L) &&
                ($(), (z.current = W), (D.current = L)),
                q(e),
                K &&
                  ("function" == typeof K
        ...
        if ((0, s.isAbsoluteUrl)(W)) Y.href = W;
        else if (!w || R || ("a" === n.type && !("href" in n.props))) {
          ...
          Y.href =
            t ||
            (0, m.addBasePath)(
              (0, c.addLocale)(W, e, null == C ? void 0 : C.defaultLocale),
            );
        }
        return w
          ? a.default.cloneElement(n, Y)
          : (0, o.jsx)("a", { ...N, ...Y, children: r });
      });
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
        ...
        try {
          ...
          if ((0, s.isDynamicRoute)(e.pathname) && e.searchParams && r) {
            let r = (0, n.searchParamsToUrlQuery)(e.searchParams),
              { result: u, params: l } = (0, c.interpolateAs)(
                e.pathname,
                e.pathname,
                r,
              );
    ...
    1394: (e, t, r) => {
      ...
      function a(e, t, r) {
        let a = "",
          ...
          l = u.groups,
          i = (t !== e ? (0, n.getRouteMatcher)(u)(t) : "") || r;
        a = e;
        let s = Object.keys(l);
        return (
          s.every((e) => {
          ...
          parameterizedRoute: t
            .map((e) => {
              let t = n.INTERCEPTION_ROUTE_MARKERS.find((t) => e.startsWith(t)),
                a = e.match(/\[((?:\[.*\])|.+)\]/);
              if (t && a) {
                let { key: e, optional: n, repeat: i } = u(a[1]);
                return (
                  (r[e] = { pos: l++, repeat: i, optional: n }),
                  "/" + (0, o.escapeStringRegexp)(t) + "([^/]+?)"
                );
              }
              if (!a) return "/" + (0, o.escapeStringRegexp)(e);
              {
                let { key: e, repeat: t, optional: n } = u(a[1]);
                return (
