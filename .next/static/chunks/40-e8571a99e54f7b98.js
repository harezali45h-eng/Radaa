...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [40],
  {
    5040: function (t, e, s) {
        ...
        f = ({ type: t, data: e }, s, i) =>
          p && e instanceof Blob
            ? s
              ? i(e)
              : y(e, i)
            : u && (e instanceof ArrayBuffer || d(e))
              ? s
                ? i(e)
                : y(new Blob([e]), i)
              : i(h[t] + (e || "")),
      ...
      for (let t = 0; t < m.length; t++) _[m.charCodeAt(t)] = t;
      let b = (t) => {
          let e = 0.75 * t.length,
            s = t.length,
            i,
        ...
        w = (t, e) => (v ? E(b(t), e) : { base64: !0, data: t }),
        E = (t, e) =>
          "blob" === e
            ? t instanceof Blob
              ? t
        ...
        T = (t, e) => {
          ...
          for (let t = 0; t < s.length; t++) {
            let r = k(s[t], e);
            if ((i.push(r), "error" === r.type)) break;
          }
          return i;
        };
      function O(t) {
      ...
      function R(t, e) {
        ...
        let s = new Uint8Array(e),
          i = 0;
        for (let r = 0; r < e; r++)
          ((s[r] = t[0][i++]), i === t[0].length && (t.shift(), (i = 0)));
        return (t.length && i < t[0].length && (t[0] = t[0].slice(i)), s);
      }
      function C(t) {
        if (t)
          return (function (t) {
            for (var e in C.prototype) t[e] = C.prototype[e];
            return t;
          })(t);
      }
      ((C.prototype.on = C.prototype.addEventListener =
        ...
        (C.prototype.emit = function (t) {
          ...
          if (s) {
            s = s.slice(0);
            for (var i = 0, r = s.length; i < r; ++i) s[i].apply(this, e);
          }
          return this;
        }),
      ...
      function q(t, e) {
        e.useNativeTimers
          ? ((t.setTimeoutFn = S.bind(x)), (t.clearTimeoutFn = L.bind(x)))
      ...
      class D extends C {
        ...
        onError(t, e, s) {
          return (super.emitReserved("error", new j(t, e, s)), this);
        }
        open() {
      ...
      class H extends C {
        ...
        _cleanup(t) {
          if (void 0 !== this._xhr && null !== this._xhr) {
            if (((this._xhr.onreadystatechange = M), t))
              try {
                this._xhr.abort();
              } catch (t) {}
        ...
        "undefined" != typeof document &&
          ("function" == typeof attachEvent
            ...
            : "function" == typeof addEventListener &&
              addEventListener(
                "onpagehide" in x ? "pagehide" : "unload",
                K,
                !1,
              )));
      let W = (function () {
      ...
      class $ extends D {
        ...
        uri() {
          let t = this.opts.secure ? "wss" : "ws",
            e = this.query || {};
          return (
            this.opts.timestampRequests && (e[this.opts.timestampParam] = P()),
                      ...
                      transform(a, h) {
                        for (s.push(a); ; ) {
                          if (0 === i) {
                            ...
                            ((n = 4294967296 * r + e.getUint32(4)), (i = 3));
                          } else {
                            if (O(s) < n) break;
                            let t = R(s, n);
                            (h.enqueue(k(o ? t : r.decode(t), e)), (i = 0));
                          }
                          if (0 === n || n > t) {
                            h.enqueue(l);
                            break;
                  ...
                  n = new TransformStream({
                    transform(t, e) {
                      ...
                      ((s = (s) => {
                        ...
                        let r = s.length;
                        if (r < 126)
                          new DataView((i = new Uint8Array(1)).buffer).setUint8(
                            0,
                            r,
                          );
                        else if (r < 65536) {
                        ...
                        p && t.data instanceof Blob
                          ? t.data.arrayBuffer().then(g).then(s)
                          : u && (t.data instanceof ArrayBuffer || d(t.data))
                            ? s(g(t.data))
                            : f(t, !1, (t) => {
                                (i || (i = new TextEncoder()), s(i.encode(t)));
                              }));
                    },
                  });
      ...
      let Z = { websocket: X, webtransport: G, polling: Y },
        tt =
      ...
      class tn extends C {
        constructor(t, e) {
          ...
          } else e.host && (e.hostname = ts(e.host).host);
          (q(this, e),
            (this.secure =
              null != e.secure
                ? e.secure
      ...
      let th = "function" == typeof ArrayBuffer,
        ...
        tp =
          "function" == typeof Blob ||
          ("undefined" != typeof Blob &&
            "[object BlobConstructor]" === tl.call(Blob)),
        tu =
          "function" == typeof File ||
          ("undefined" != typeof File &&
            "[object FileConstructor]" === tl.call(File));
      function td(t) {
        return (
          (th && (t instanceof ArrayBuffer || tc(t))) ||
          (tp && t instanceof Blob) ||
      ...
      class tg {
        ...
        encode(t) {
          return (t.type === o.EVENT || t.type === o.ACK) &&
            (function t(e, s) {
              ...
              return (
                (t.data = (function t(e, s) {
                  ...
                  if (Array.isArray(e)) {
                    ...
                    for (let r = 0; r < e.length; r++) i[r] = t(e[r], s);
                    return i;
                  }
      ...
      class t_ extends C {
        ...
        decodeString(t) {
          ...
          if (t.charAt(++e)) {
            ...
            if (t_.isPayloadValid(s.type, i)) s.data = i;
          ...
          switch (t) {
            ...
            case o.BINARY_EVENT:
              return (
                Array.isArray(e) &&
                ("number" == typeof e[0] ||
                  ("string" == typeof e[0] && -1 === tf.indexOf(e[0])))
              );
            case o.ACK:
            case o.BINARY_ACK:
          ...
          if (
            ...
            let t =
              ...
              (e.data = (function t(e, s) {
                ...
                if (Array.isArray(e))
                  for (let i = 0; i < e.length; i++) e[i] = t(e[i], s);
      ...
      class tw extends C {
        ...
        subEvents() {
          ...
          let t = this.io;
          this.subs = [
            tv(t, "open", this.onopen.bind(this)),
            tv(t, "packet", this.onpacket.bind(this)),
            tv(t, "error", this.onerror.bind(this)),
            tv(t, "close", this.onclose.bind(this)),
          ];
        }
        get active() {
          return !!this.subs;
        ...
        _registerAckCallback(t, e) {
          ...
          let r = this.io.setTimeoutFn(() => {
            ...
            n = (...t) => {
              (this.io.clearTimeoutFn(r), e.apply(this, t));
            };
        ...
        ack(t) {
          let e = this,
            s = !1;
          return function (...i) {
            s || ((s = !0), e.packet({ type: o.ACK, id: t, data: i }));
          };
        }
        onack(t) {
      ...
      class tA extends C {
        ...
        onopen() {
          ...
          let t = this.engine;
          this.subs.push(
            tv(t, "ping", this.onping.bind(this)),
            tv(t, "data", this.ondata.bind(this)),
            tv(t, "error", this.onerror.bind(this)),
            tv(t, "close", this.onclose.bind(this)),
            tv(this.decoder, "decoded", this.ondecoded.bind(this)),
          );
        }
        onping() {
          this.emitReserved("ping");
      ...
      function tO(t, e) {
        ...
        return (
          e.forceNew || e["force new connection"] || !1 === e.multiplex || a
            ? (s = new tA(r, e))
            : (tT[n] || (tT[n] = new tA(r, e)), (s = tT[n])),
          i.query && !e.query && (e.query = i.queryKey),
          s.socket(i.path, e)
        );
      }
      Object.assign(tO, { Manager: tA, Socket: tw, io: tO, connect: tO });
    },
  },
]);
