  ...
  [472],
  {
                    ...
                    switch (n) {
                      ...
                      case "utf-8":
                        return (
                          (u = t),
                          (f = r),
                          U(R(e, this.length - u), this, u, f)
                        );
                      case "ascii":
                        return ((l = t), (c = r), U(T(e), this, l, c));
                      case "latin1":
                      case "binary":
                        return (
                          (o = this),
    ...
    8472: function (e, t, r) {
      ...
      let S = w("ArrayBuffer"),
        ...
        N = w("FileList"),
        P = w("URLSearchParams"),
        [k, _, F, I] = ["ReadableStream", "Request", "Response", "Headers"].map(
          w,
        );
      ...
      let q =
        ...
        z = (e) => !O(e) && e !== q,
        J =
          ((o = "undefined" != typeof Uint8Array && y(Uint8Array)),
          (e) => o && e instanceof o),
        W = w("HTMLFormElement"),
        H = (
          ({ hasOwnProperty: e }) =>
            ...
            : u
              ? ((f = `axios@${Math.random()}`),
                ...
                q.addEventListener(
                  "message",
                  ({ source: e, data: t }) => {
                    e === q && t === f && l.length && l.shift()();
                  },
                  !1,
                ),
                (e) => {
                  (l.push(e), q.postMessage(f, "*"));
                })
              : (e) => setTimeout(e)),
        Y =
          "undefined" != typeof queueMicrotask
            ? queueMicrotask.bind(q)
            : (void 0 !== p && p.nextTick) || X;
      var G = {
        isArray: E,
        isArrayBuffer: S,
        isBuffer: A,
        ...
        isRegExp: $,
        isFunction: T,
        isStream: (e) => U(e) && T(e.pipe),
        isURLSearchParams: P,
        isTypedArray: J,
        isFileList: N,
        forEach: D,
        merge: function e() {
          let { caseless: t, skipUndefined: r } = (z(this) && this) || {},
            n = {},
            o = (o, i) => {
              let s = (t && M(n, i)) || i;
              C(n[s]) && C(o)
        ...
        freezeMethods: (e) => {
          V(e, (t, r) => {
            if (T(e) && -1 !== ["arguments", "caller", "callee"].indexOf(r))
              return !1;
            if (T(e[r])) {
        ...
        isSpecCompliantForm: function (e) {
          return !!(e && T(e.append) && "FormData" === e[m] && e[g]);
        },
        toJSONObject: (e) => {
          let t = Array(10),
            r = (e, n) => {
        ...
        isAsyncFn: K,
        isThenable: (e) => e && (U(e) || T(e)) && T(e.then) && T(e.catch),
        setImmediate: X,
        asap: Y,
        isIterable: (e) => null != e && T(e[g]),
      };
      ...
      let ei = G.toFlatObject(G, {}, null, function (e) {
        ...
        function f(e, r, o) {
          ...
          if (e && !o && "object" == typeof e) {
            if (G.endsWith(r, "{}"))
              ...
              var f;
              if (
                (G.isArray(e) && ((f = e), G.isArray(f) && !f.some(er))) ||
                ((G.isFileList(e) || G.endsWith(r, "[]")) && (a = G.toArray(e)))
              )
                return (
                  (r = en(r)),
                ...
                G.forEach(r, function (r, i) {
                  !0 ===
                    (!(G.isUndefined(r) || null === r) &&
                      o.call(t, r, G.isString(i) ? i.trim() : i, n, c)) &&
                    e(r, n ? n.concat(i) : [i]);
                }),
                l.pop());
            }
      ...
      var eO = {
          ...c,
          isBrowser: !0,
          classes: { URLSearchParams: ed, FormData: ey, Blob: eg },
        ...
        transformRequest: [
          function (e, t) {
            ...
            if (
              ...
              return o ? JSON.stringify(eA(e)) : e;
            if (
              G.isArrayBuffer(e) ||
              G.isBuffer(e) ||
              G.isStream(e) ||
            ...
            if (i) {
              if (n.indexOf("application/x-www-form-urlencoded") > -1) {
                ...
                es(s, new eO.classes.URLSearchParams(), {
                  visitor: function (e, t, r, n) {
                    return eO.isNode && G.isBuffer(e)
      ...
      function eC(e) {
        return !1 === e || null == e ? e : G.isArray(e) ? e.map(eC) : String(e);
      }
      ...
      class ej {
        ...
        set(e, t, r) {
          ...
          else if (G.isString(e) && (e = e.trim()) && !ex(e)) i(eT(e), t);
        ...
        static accessor(e) {
          let t = (this[eB] = this[eB] = { accessors: {} }).accessors,
            r = this.prototype;
          function n(e) {
            let n = eU(e);
            t[n] ||
              (!(function (e, t) {
                let r = G.toCamelCase(" " + t);
      ...
      (ej.accessor([
        ...
        G.reduceDescriptors(ej.prototype, ({ value: e }, t) => {
      ...
      let eD = (e, t, r = 3) => {
        ...
        eq =
          ...
          (...t) =>
            G.asap(() => e(...t));
      var ez = eO.hasStandardBrowserEnv
          ? ((i = new URL(eO.origin)),
            (s =
              eO.navigator && /(msie|trident)/i.test(eO.navigator.userAgent)),
            (e) => (
              (e = new URL(e, eO.origin)),
              i.protocol === e.protocol &&
                i.host === e.host &&
                (s || i.port === e.port)
            ))
          : () => !0,
        eJ = eO.hasStandardBrowserEnv
          ? {
              write(e, t, r, n, o, i, s) {
                if ("undefined" == typeof document) return;
                let a = [`${e}=${encodeURIComponent(t)}`];
                (G.isNumber(r) &&
                  a.push(`expires=${new Date(r).toUTCString()}`),
                  G.isString(n) && a.push(`path=${n}`),
                  G.isString(o) && a.push(`domain=${o}`),
                  !0 === i && a.push("secure"),
                  G.isString(s) && a.push(`SameSite=${s}`),
      ...
      var eV = (e) => {
          ...
          if (
            ((t.headers = s = ej.from(s)),
            (t.url = ec(
              eW(t.baseURL, t.url, t.allowAbsoluteUrls),
              e.params,
              e.paramsSerializer,
            )),
            a &&
          ...
          if (
            eO.hasStandardBrowserEnv &&
            (n && G.isFunction(n) && (n = n(t)), n || (!1 !== n && ez(t.url)))
          ) {
            let e = o && i && eJ.read(i);
            e && s.set(o, e);
          }
          ...
          function (e) {
            return new Promise(function (t, r) {
              ...
              (y.open(u.method.toUpperCase(), u.url, !0),
                ...
                (y.onabort = function () {
                  y &&
                    (r(new Z("Request aborted", Z.ECONNABORTED, e, y)),
                    (y = null));
                }),
                ...
                G.isUndefined(u.withCredentials) ||
                  (y.withCredentials = !!u.withCredentials),
                c && "json" !== c && (y.responseType = u.responseType),
                p && (([i, a] = eD(p, !0)), y.addEventListener("progress", i)),
                h &&
                  y.upload &&
                  (([o, s] = eD(h)),
      ...
      let eY = function* (e, t) {
        ...
        { isFunction: e0 } = G,
        e1 = (({ Request: e, Response: t }) => ({ Request: e, Response: t }))(
          G.global,
        ),
        { ReadableStream: e2, TextEncoder: e5 } = G.global,
        e6 = (e, ...t) => {
          try {
            return !!e(...t);
          } catch (e) {
        ...
        e8 = (e) => {
          ...
          let {
              ...
              Request: n,
              Response: o,
            } = (e = G.merge.call({ skipUndefined: !0 }, e1, e)),
            i = r ? e0(r) : "function" == typeof fetch,
            s = e0(n),
            a = e0(o);
          if (!i) return !1;
          let u = i && e0(e2),
            ...
            c = a && u && e6(() => G.isReadableStream(new o("").body)),
            h = { stream: c && ((e) => e.body) };
          i &&
          ...
          let p = async (e) => {
              ...
              if (G.isSpecCompliantForm(e)) {
                let t = new n(eO.origin, { method: "POST", body: e });
          ...
          return async (e) => {
            ...
            let A = eX([f, p && p.toAbortSignal()], y),
              S = null,
              R =
                A &&
                A.unsubscribe &&
            ...
            try {
              if (
                ...
                let e,
                  r = new n(i, { method: "POST", body: u, duplex: "half" });
                if (
                  (G.isFormData(u) &&
                  ...
                  let [e, n] = eM(t, eD(eq(m)));
                  u = eQ(r.body, 65536, e, n);
                }
              }
              ...
              if (c && (g || (y && R))) {
                ...
                let t = G.toFiniteNumber(p.headers.get("content-length")),
                  [r, n] = (g && eM(t, eD(eq(g), !0))) || [];
                p = new o(
                  eQ(p.body, 65536, r, () => {
                    (n && n(), R && R());
                  }),
              ...
              b = b || "text";
              let T = await h[G.findKey(h, b) || "text"](p, e);
              return (
                !y && R && R(),
                await new Promise((t, r) => {
                  e_(t, r, {
                    data: T,
                    headers: ej.from(p.headers),
                    status: p.status,
              ...
              if (
                ...
                throw Object.assign(
                  new Z("Network Error", Z.ERR_NETWORK, e, S),
                  { cause: t.cause || t },
                );
              throw Z.from(t, t && t.code, e, S);
            }
          };
        },
        e4 = new Map(),
        e3 = (e) => {
          ...
          for (; s--; )
            ((a = i[s]),
              void 0 === (u = f.get(a)) &&
                f.set(a, (u = s ? new Map() : e8(t))),
              (f = u));
          return u;
        };
      e3();
      let e7 = { http: null, xhr: eK, fetch: { get: e3 } };
      G.forEach(e7, (e, t) => {
        if (e) {
          try {
      ...
      let e9 = (e) => `- ${e}`,
        te = (e) => G.isFunction(e) || null === e || !1 === e;
      var tt = function (e, t) {
        let r, n;
        let { length: o } = (e = G.isArray(e) ? e : [e]),
          i = {};
        for (let s = 0; s < o; s++) {
          let o;
          if (
            ((n = r = e[s]),
            !te(r) && void 0 === (n = e7[(o = String(r)).toLowerCase()]))
          )
      ...
      class tf {
        constructor(e) {
          ((this.defaults = e || {}),
            (this.interceptors = { request: new eh(), response: new eh() }));
        }
        async request(e, t) {
          try {
        ...
        getUri(e) {
          return ec(
            eW((e = e$(this.defaults, e)).baseURL, e.url, e.allowAbsoluteUrls),
            e.params,
            e.paramsSerializer,
          );
        }
      ...
      (G.forEach(["delete", "get", "head", "options"], function (e) {
        tf.prototype[e] = function (t, r) {
          return this.request(
            e$(r || {}, { method: e, url: t, data: (r || {}).data }),
          );
        };
      }),
      ...
      let th = (function e(t) {
        ...
        return (
          G.extend(n, tf.prototype, r, { allOwnKeys: !0 }),
      ...
      ((th.Axios = tf),
        ...
        (th.mergeConfig = e$),
        (th.AxiosHeaders = ej),
        (th.formToJSON = (e) => eA(G.isHTMLForm(e) ? new FormData(e) : e)),
        (th.getAdapter = tt),
        (th.HttpStatusCode = tc),
        (th.default = th));
      var tp = th;
    },
  },
